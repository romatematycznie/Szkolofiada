    ...
    <div className="max-w-4xl mx-auto px-6 py-16">
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-700 leading-relaxed mb-4">
          Szkolofiada oznacza okres czterech kolejnych lat kalendarzowych. Szkolofiady są numerowane kolejno od pierwszych Igrzysk Szkolofiady, które odbyły się w Toruniu i Bydgoszczy w 2023 roku.
        </p>
        <p className="text-gray-700 leading-relaxed mb-4">
